        ...
        <div class="content-wrapper">
            ...
            <div class="col-md-12 grid-margin">
              <div class="d-flex justify-content-between flex-wrap">
                ...
                <div class="d-flex justify-content-between align-items-end flex-wrap">
                  <a href="add-product.php" class="btn btn-primary mt-2 mt-xl-0">Add Product</a>
                </div>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12 stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title">Products Information</p>
                    ...
                    <table id="recent-purchases-listing" class="table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="update-product?product_id=<?= $row["id"] ?>&barcode=<?= $row["barcode"] ?>&prod_desc=<?= $row["prod_desc"] ?>&stocks=<?= $row["stocks"] ?>&cost=<?= $row["cost"] ?>&markup=<?= $row["markup"] ?>" class="btn btn-primary text-white"><i class="mdi mdi-pencil"></i></a>
                            <a href="delete-product?product_id=<?= $row["id"] ?>" class="btn btn-danger text-white"><i class="mdi mdi-delete"></i></a>
                          </td>
                        </tr>
                        <?php } ?>
                      </tbody>
