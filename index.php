      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="row">
            <div class="col-md-12 stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title">Recent Pay Later</p>
                  <div class="table-responsive">
                    <table id="recent-pay-later-listing" class="table">
                      <thead>
                        <tr>
                          <th>Transaction #</th>
                          <th>Payer</th>
                      ...
                      <tbody>
                        <?php
                            $fetchPayLater = $transactionFacade->fetchPayLater();
                            while ($row = $fetchPayLater->fetch(PDO::FETCH_ASSOC)) { ?>
                          <tr>
                            <td><?= $row["transaction_num"] ?></td>
                            <td><?= $row["payer"] ?></td>
                            <td><a href="view-receipt?transaction_num=<?= $row['transaction_num'] ?>" class="text-decoration-none">View Receipt</a></td>
                            <td>
                              <?php
                                if ($row["is_paid"] == '0') { ?>
                                  <a href="pay?transaction_num=<?= $row['transaction_num'] ?>" class="btn btn-primary text-white pt-1">Pay</a></td>
                              <?php } else { ?>
        ...
        <footer class="footer">
          <div class="d-sm-flex justify-content-center justify-content-sm-between">
            ...
            <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center">Powered By: <a href="https://www.appworksco.com/" target="_blank">Appworks Co.</a></span>
          </div>
        </footer>
        <!-- partial -->
      </div>
