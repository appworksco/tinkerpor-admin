          ...
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              <div class="brand-logo text-center">
                <img src="assets/img/transak-pos-logo.png" alt="logo">
              </div>
              ...
              <form action="login.php" class="pt-3" method="post">
                ...
                <div class="mt-3">
                  <button class="btn btn-block bg-gradient-to-right btn-lg text-white font-weight-medium auth-form-btn w-100" name="login">Login</button>
                </div>
              </form>
            </div>
          </div>
